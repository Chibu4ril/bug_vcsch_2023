...
import styles from "./GetFunded.module.css";
    ...
    <div>
      <div className={`${styles.navContainer} mx-auto py-28 `}>
        ...
        <div className="text-center mx-auto my-20">
          <div className="grid grid-cols-5 grid-flow-dense  my-28">
            <div>
          ...
          <div className="mx-auto mt-20 flex justify-center align-middle content-center gap-5">
            <LinkButton className="btn" href="">
              View requirements
            </LinkButton>
